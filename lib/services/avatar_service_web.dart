...
class AvatarService {
  ...
  static Future<void> saveAvatar(String base64Image) async {
    final domain = web.window.location.hostname;
    final avatarKey = "tlu_avatar_${domain}_base64";
    web.window.localStorage.setItem(avatarKey, base64Image);
    web.window.sessionStorage.setItem('tlu_avatar_session', base64Image);
  }
  ...
  static Future<String?> loadAvatar() async {
    final domain = web.window.location.hostname;
    final avatarKey = "tlu_avatar_${domain}_base64";
    return web.window.localStorage.getItem(avatarKey) ?? web.window.sessionStorage.getItem('tlu_avatar_session');
  }
  ...
  static Future<void> removeAvatar() async {
    final domain = web.window.location.hostname;
    final avatarKey = "tlu_avatar_${domain}_base64";
    web.window.localStorage.removeItem(avatarKey);
    web.window.sessionStorage.removeItem('tlu_avatar_session');
  }
